...
### The main function
def sol_dream11(output_filename, input_filename='', M=None, include_diagonal = False, mat=None, directed = False, svd_k = 50, svd_maxiter = 100, svt_delta = 1.5, e=0.0001, svt_maxiter=100, save_feature=False, feature_filename='', n_neighbors = 100, n_clusters=1000, linkage='ward', module_size = 40, constraint2 = False, n_neighbors2=100):
    if M is None and mat is None:
    ...
    module_disc(X, output_filename, n_neighbors = n_neighbors, n_clusters=n_clusters, linkage=linkage, module_size = module_size, constraint2 = constraint2, n_neighbors2=n_neighbors2)                          
...
print 'SIGNAL:'
signal = np.loadtxt(open("subchallenge1/3_signal_anonym_directed_v3.txt", "r"), delimiter='\t')
...
sol_dream11('submitted/3_signal_260.txt', M=signal, directed = True, svd_k=30, n_clusters=260, save_feature=True, feature_filename='submitted/SIGNAL_feature.pkl')

print 'COEXPR:'
sol_dream11('submitted/4_coexpr_340.txt', input_filename='subchallenge1/4_coexpr_anonym_v2.txt', n_clusters=340, save_feature=True, feature_filename='submitted/COEXPR_feature.pkl')
...
print 'HOMOLOGY:'
homology = np.loadtxt(open("subchallenge1/6_homology_anonym_v2.txt", "r"), delimiter='\t')
...
sol_dream11('submitted/6_homology_260.txt', M=homology, n_clusters=260, save_feature=True, feature_filename='submitted/HOMOLOGY_feature.pkl')
